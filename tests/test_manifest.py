...
def adjective_to_animals_data():
    ...
    return {
        ...
        "avian": [
            {
                "name": "bird",
                "image_path": "data/images/bird.jpg"
            }
        ]
    }
...
def test_load_manifest_with_adjective_format(sample_adjective_manifest_file, adjective_to_animals_data):
...
def test_load_manifest_with_animal_format(mock_parse_table, sample_manifest_file, manifest_data):
